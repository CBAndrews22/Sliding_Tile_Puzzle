Solution: Project_1.o Manhattan_Dist.o Misplaced_Tile.o Uniform_Cost_Search.o Puzzle_Game.o Node.o 
	g++ Project_1.o Manhattan_Dist.o Misplaced_Tile.o Uniform_Cost_Search.o Puzzle_Game.o Node.o -o Solution

Debug: 
	g++ Project_1.cpp Manhattan_Dist.cpp Misplaced_Tile.cpp Uniform_Cost_Search.cpp Puzzle_Game.cpp Node.cpp -g -o debug
